          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginTop: '1rem' }}>
            {logs.map((log, index) => (
              ...
              >
                ...
                <p style={{ fontSize: '0.85rem', fontFamily: 'monospace', color: 'var(--ink)' }}>
                  {log.message}
                </p>
                {log.details && Object.keys(log.details).length > 0 && (
                  <div style={{ marginTop: '0.5rem', padding: '0.5rem', backgroundColor: 'var(--bg-body)', borderRadius: '4px', fontSize: '0.75rem', fontFamily: 'monospace', color: 'var(--muted)', whiteSpace: 'pre-wrap', wordBreak: 'break-all' }}>
