...
alter table public.automailsend_sent_log add column if not exists subject text default '';
alter table public.automailsend_sent_log add column if not exists body text default '';
...
-- 10. Auto-Fetch & Worker Configuration for automailsend_app_state
...
-- 11. Create Execution Logs table
